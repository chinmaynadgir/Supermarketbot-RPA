...
dict_from_csv = pd.read_csv('inventory_records1.csv', index_col=0, squeeze=True).to_dict()
...
class Bill_App:
    ...
    # ===========ColdDrinks================================
        ...
        mountain_duo_lbl = Label(F4, text="Mountain Dew", font=('times new roman', 16, 'bold'), bg="#badc57", fg="black")
    ...
    def total(self):
        ...
        self.m_sa_p = self.sanitizer.get()*2
...
#initializing everything to new value
    def modify_items(self):
        inventory_dict=[
                {'item':'sanitizer_l','quantity':dict_from_csv['sanitizer_l']},
                {'item':'mask_l','quantity':dict_from_csv['mask_l']},
                {'item':'hand_gloves_l','quantity':dict_from_csv['hand_gloves_l']},
                {'item':'syrup_l','quantity':dict_from_csv['syrup_l']},
                {'item':'cream_l','quantity':dict_from_csv['cream_l']},
                {'item':'thermal_gun_l','quantity':dict_from_csv['thermal_gun_l']},
                {'item':'rice_l','quantity':dict_from_csv['rice_l']},
                {'item':'food_oil_l','quantity':dict_from_csv['food_oil_l']},
                {'item':'wheat_l','quantity':dict_from_csv['wheat_l']},
                {'item':'spices_l','quantity':dict_from_csv['spices_l']},
                {'item':'flour_l','quantity':dict_from_csv['flour_l']},
                {'item':'maggi_l','quantity':dict_from_csv['maggi_l']},
                {'item':'sprite_l','quantity':dict_from_csv['sprite_l']},
                {'item':'mineral_l','quantity':dict_from_csv['mineral_l']},
                {'item':'juice_l','quantity':dict_from_csv['juice_l']},
                {'item':'coke_l','quantity':dict_from_csv['coke_l']},
                {'item':'lassi_l','quantity':dict_from_csv['lassi_l']},
                {'item':'mountain_duo_l','quantity':dict_from_csv['mountain_duo_l']},
                ]
    ...
    # ===============taxes==============================
        ...
        dict_from_csv['sanitizer_l']=dict_from_csv['sanitizer_l']-self.sanitizer.get()
        dict_from_csv['mask_l']=dict_from_csv['mask_l']-self.mask.get()
        dict_from_csv['hand_gloves_l']=dict_from_csv['hand_gloves_l']-self.hand_gloves.get()
        dict_from_csv['syrup']=dict_from_csv['syrup_l']-self.syrup.get()
        dict_from_csv['thermal_gun_l']=dict_from_csv['thermal_gun_l']-self.thermal_gun.get()
        dict_from_csv['cream_l']=dict_from_csv['cream_l']-self.cream.get()
        
    # ============grocery==============================
        dict_from_csv['rice_l']=dict_from_csv['rice_l']-self.rice.get()
        dict_from_csv['food_oil_l']=dict_from_csv['food_oil_l']-self.food_oil.get()
        dict_from_csv['wheat_l']=dict_from_csv['wheat_l']-self.wheat.get()
        dict_from_csv['spices_l']=dict_from_csv['spices_l']-self.spices.get()
        dict_from_csv['flour_l']=dict_from_csv['flour_l']-self.flour.get()
        dict_from_csv['maggi_l']=dict_from_csv['maggi_l']-self.maggi.get()
        #=============coldDrinks=============================
        dict_from_csv['sprite_l']=dict_from_csv['sprite_l']-self.sprite.get()
        dict_from_csv['mineral_l']=dict_from_csv['mineral_l']-self.mineral.get()
        dict_from_csv['juice_l']=dict_from_csv['juice_l']-self.juice.get()
        dict_from_csv['coke_l']=dict_from_csv['coke_l']-self.coke.get()
        dict_from_csv['lassi_l']=dict_from_csv['lassi_l']-self.lassi.get()
        dict_from_csv['mountain_duo_l']=dict_from_csv['mountain_duo_l']-self.mountain_duo.get()
